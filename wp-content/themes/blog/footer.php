	...
	<div id="footer-bottom-area" class="container">
		<p id="copyright"><?php printf( __( 'Desenvolvido por %1$s | Powered by %2$s', 'Foxy' ), '<a href="http://www.acens.com.br" title="Premium WordPress Themes">Acens</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
	</div>
